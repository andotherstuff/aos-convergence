...
// .wrangler/tmp/bundle-xfMbsX/strip-cf-connecting-ip-header.js
...
function weierstrass(params, extraOpts = {}) {
  ...
  class Point {
    ...
    multiply(scalar) {
      ...
      let point, fake;
      const mul3 = /* @__PURE__ */ __name((n) => wnaf.cached(this, n, (p) => normalizeZ(Point, p)), "mul");
      if (endo2) {
...
var radix2carry = (
  /* @__NO_SIDE_EFFECTS__ */
  /* @__PURE__ */ __name((from, to) => from + (to - gcd(from, to)), "radix2carry")
);
var powers = /* @__PURE__ */ (() => {
  let res = [];
...
var decodeBase64Builtin = /* @__PURE__ */ __name((s, isUrl) => {
  astr("base64", s);
...
var genBase58 = (
  /* @__NO_SIDE_EFFECTS__ */
  /* @__PURE__ */ __name((abc) => chain(radix(58), alphabet(abc), join("")), "genBase58")
);
...
var wrapCipher = /* @__PURE__ */ __name((params, constructor) => {
...
var cbc = /* @__PURE__ */ wrapCipher({ blockSize: 16, nonceLength: 16 }, /* @__PURE__ */ __name(function aescbc(key, iv, opts = {}) {
...
__name(_CMAC, "_CMAC");
var cmac = /* @__PURE__ */ __name((key, message) => new _CMAC(key).update(message).digest(), "cmac");
...
__name(mergeReverseSortedLists, "mergeReverseSortedLists");
var JS = /* @__PURE__ */ __name(class {
  generateSecretKey() {
...
__name(getPowFromBytes, "getPowFromBytes");
...
var channelCreateEvent = /* @__PURE__ */ __name((t, privateKey) => {
  let content;
...
var channelMetadataEvent = /* @__PURE__ */ __name((t, privateKey) => {
  let content;
  if (typeof t.content === "object") {
    content = JSON.stringify(t.content);
  } else if (typeof t.content === "string") {
...
var channelMessageEvent = /* @__PURE__ */ __name((t, privateKey) => {
...
var channelHideMessageEvent = /* @__PURE__ */ __name((t, privateKey) => {
  let content;
  if (typeof t.content === "object") {
    content = JSON.stringify(t.content);
  } else if (typeof t.content === "string") {
...
var channelMuteUserEvent = /* @__PURE__ */ __name((t, privateKey) => {
  let content;
  if (typeof t.content === "object") {
    content = JSON.stringify(t.content);
  } else if (typeof t.content === "string") {
...
var regex = /* @__PURE__ */ __name(() => new RegExp(`\\B${EMOJI_SHORTCODE_REGEX.source}\\B`, "g"), "regex");
...
var WrappedBuffer = /* @__PURE__ */ __name(class {
  _raw;
  length;
  constructor(buffer) {
...
var Accumulator = /* @__PURE__ */ __name(class {
  buf;
  constructor() {
    this.setToZero();
  }
...
var NegentropyStorageVector = /* @__PURE__ */ __name(class {
  items;
  sealed;
  constructor() {
    this.items = [];
...
var Negentropy = /* @__PURE__ */ __name(class {
  storage;
  frameSizeLimit;
  lastTimestampIn;
  lastTimestampOut;
...
__name(compareUint8Array, "compareUint8Array");
...
__name(itemCompare, "itemCompare");
var NegentropySync = /* @__PURE__ */ __name(class {
  relay;
  storage;
  neg;
  filter;
...
// src/index.ts
function getEventDetails(signalGroupLink) {
  return {
    signalGroupLink,
    schedule: [
      {
        day: "Day 1 \u2014 Thursday, May 29",
        subtitle: "Arrivals & Opening",
        items: [
          { time: "14:00\u201315:00", event: "Registration & Welcome" },
          { time: "15:00\u201316:30", event: "Opening Session \u2014 Introductions & State of the Ecosystem" },
          { time: "16:30\u201317:00", event: "Break" },
          { time: "17:00\u201318:30", event: "Lightning Talks \u2014 What Are You Building?" },
      ...
      },
      {
        ...
        items: [
          ...
          { time: "09:30\u201312:00", event: "Working Sessions \u2014 Breakout Groups" },
          { time: "12:00\u201313:30", event: "Lunch" },
          { time: "13:30\u201316:00", event: "Product Demos & Feedback Rounds" },
          { time: "16:00\u201316:30", event: "Break" },
          { time: "16:30\u201318:00", event: "Open Discussion \u2014 Hard Problems in Freedom Tech" },
          { time: "19:30", event: "Dinner in Oslo" }
        ]
      },
      {
        ...
        items: [
          { time: "09:00\u201309:30", event: "Coffee & Breakfast" },
          { time: "09:30\u201311:30", event: "Collaboration Proposals & Commitments" },
          { time: "11:30\u201312:30", event: "Closing Session \u2014 What's Next" },
          { time: "12:30\u201314:00", event: "Farewell Lunch" },
          { time: "14:00+", event: "Optional \u2014 Explore Oslo" }
        ]
      }
    ],
    location: {
...
__name(getEventDetails, "getEventDetails");
...
async function handleEventRequest(request, env, headers) {
  ...
  if (Math.abs(now2 - event.created_at) > 60) {
    return new Response(
  ...
  const npub = nip19_exports.npubEncode(event.pubkey);
  const approvedNpubs = env.APPROVED_NPUBS.split(",").map((s) => s.trim());
...
// .wrangler/tmp/bundle-xfMbsX/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-xfMbsX/middleware-loader.entry.ts
